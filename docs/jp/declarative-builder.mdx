...
以下の機能を提供します。完全なAPIリファレンスとメソッドシグネチャについては、[Python](/docs/jp/python-sdk/common/image) および [TypeScript](/docs/jp/typescript-sdk/image) のSDKリファレンスを参照してください。
...
詳細なメソッドシグネチャや使用例については、[Python](/docs/jp/python-sdk/common/image) および [TypeScript](/docs/jp/typescript-sdk/image) のSDKリファレンスを参照してください。
