...
See: [get_preview_link (Python SDK)](/docs/jp/python-sdk/sync/sandbox#sandboxget_preview_link), [getPreviewLink (TypeScript SDK)](/docs/jp/typescript-sdk/sandbox#getpreviewlink), [preview_url (Ruby SDK)](/docs/jp/ruby-sdk/sandbox#preview_url)
...
See: [create_signed_preview_url (Python SDK)](/docs/jp/python-sdk/sync/sandbox#sandboxcreate_signed_preview_url), [getSignedPreviewUrl (TypeScript SDK)](/docs/jp/typescript-sdk/sandbox#getsignedpreviewurl), [preview_url (Ruby SDK)](/docs/jp/ruby-sdk/sandbox#preview_url)
...
<Tip>
If you want to serve the previews under your own domain instead of using Daytona's URLs, check out the [Custom Domain/Authentication](/docs/jp/custom-domain-authentication) section.
</Tip>
...
- Upgrade to [Tier 3](/docs/jp/limits)
- Deploy your own [custom preview proxy](/docs/jp/custom-domain-authentication)
