...
For more information, see the [Python SDK](/docs/jp/python-sdk/sync/process), [TypeScript SDK](/docs/jp/typescript-sdk/process#createpty), [Ruby SDK](/docs/en/ruby-sdk/process), [Go SDK](/docs/jp/go-sdk/daytona#type-processservice), and [API](/docs/jp/tools/api#daytona-toolbox/tag/process) references:

> [**create_pty_session (Python SDK)**](/docs/jp/python-sdk/sync/process#processcreate_pty_session)
>
> [**createPty (TypeScript SDK)**](/docs/jp/typescript-sdk/process#createpty)
>
> [**create_pty_session (Ruby SDK)**](/docs/en/ruby-sdk/process#create_pty_session)
>
> [**CreatePty (Go SDK)**](/docs/jp/go-sdk/daytona#ProcessService.CreatePty)
>
> [**Create PTY session (API)**](/docs/jp/tools/api#daytona-toolbox/tag/process/POST/process/pty)
...
For more information, see the [Python SDK](/docs/jp/python-sdk/sync/process), [TypeScript SDK](/docs/jp/typescript-sdk/process), [Ruby SDK](/docs/en/ruby-sdk/process), [Go SDK](/docs/jp/go-sdk/daytona#type-processservice), and [API](/docs/jp/tools/api#daytona-toolbox/tag/process) references:

> [**connect_pty_session (Python SDK)**](/docs/jp/python-sdk/sync/process#processconnect_pty_session)
>
> [**connectPty (TypeScript SDK)**](/docs/jp/typescript-sdk/process#connectpty)
>
> [**connect_pty_session (Ruby SDK)**](/docs/en/ruby-sdk/process#connect_pty_session)
>
> [**ConnectPty (Go SDK)**](/docs/jp/go-sdk/daytona#ProcessService.ConnectPty)
>
> [**Connect to PTY session (API)**](/docs/jp/tools/api#daytona-toolbox/tag/process/GET/process/pty/{sessionId}/connect)
...
> [**list_pty_sessions (Python SDK)**](/docs/jp/python-sdk/sync/process#processlist_pty_sessions)
>
> [**listPtySessions (TypeScript SDK)**](/docs/jp/typescript-sdk/process#listptysessions)
>
> [**list_pty_sessions (Ruby SDK)**](/docs/en/ruby-sdk/process#list_pty_sessions)
>
> [**ListPtySessions (Go SDK)**](/docs/jp/go-sdk/daytona#ProcessService.ListPtySessions)
>
> [**List PTY sessions (API)**](/docs/jp/tools/api#daytona-toolbox/tag/process/GET/process/pty)
...
> [**get_pty_session_info (Python SDK)**](/docs/jp/python-sdk/sync/process#processget_pty_session_info)
>
> [**getPtySessionInfo (TypeScript SDK)**](/docs/jp/typescript-sdk/process#getptysessioninfo)
>
> [**get_pty_session_info (Ruby SDK)**](/docs/en/ruby-sdk/process#get_pty_session_info)
>
> [**GetPtySessionInfo (Go SDK)**](/docs/jp/go-sdk/daytona#ProcessService.GetPtySessionInfo)
>
> [**Get PTY session info (API)**](/docs/jp/tools/api#daytona-toolbox/tag/process/GET/process/session/{sessionId})
...
For more information, see the [Python SDK](/docs/jp/python-sdk/sync/process), [TypeScript SDK](/docs/jp/typescript-sdk/process), [Ruby SDK](/docs/en/ruby-sdk/process#delete_pty_session), [Go SDK](/docs/jp/go-sdk/daytona#type-processservice), and [API](/docs/jp/tools/api#daytona-toolbox/tag/process) references:

> [**kill_pty_session (Python SDK)**](/docs/jp/python-sdk/sync/process#processkill_pty_session)
>
> [**killPtySession (TypeScript SDK)**](/docs/jp/typescript-sdk/process#killptysession)
>
> [**delete_pty_session (Ruby SDK)**](/docs/en/ruby-sdk/process#delete_pty_session)
>
> [**KillPtySession (Go SDK)**](/docs/jp/go-sdk/daytona#ProcessService.KillPtySession)
>
> [**Kill PTY session (API)**](/docs/jp/tools/api#daytona-toolbox/tag/process/DELETE/process/session/{sessionId})
...
For more information, see the [Python SDK](/docs/jp/python-sdk/sync/process), [TypeScript SDK](/docs/jp/typescript-sdk/process#resizeptysession), [Ruby SDK](/docs/en/ruby-sdk/process), [Go SDK](/docs/jp/go-sdk/daytona#type-processservice), and [API](/docs/jp/tools/api#daytona-toolbox/tag/process) references:

> [**resize_pty_session (Python SDK)**](/docs/jp/python-sdk/sync/process#processresize_pty_session)
>
> [**resizePtySession (TypeScript SDK)**](/docs/jp/typescript-sdk/process#resizeptysession)
>
> [**resize_pty_session (Ruby SDK)**](/docs/en/ruby-sdk/process#resize_pty_session)
>
> [**ResizePtySession (Go SDK)**](/docs/jp/go-sdk/daytona#ProcessService.ResizePtySession)
>
> [**Resize PTY session (API)**](/docs/jp/tools/api#daytona-toolbox/tag/process/POST/process/pty/{sessionId}/resize)
...
For more information, see the [Python SDK](/docs/jp/python-sdk), [TypeScript SDK](/docs/jp/typescript-sdk), [Ruby SDK](/docs/jp/ruby-sdk), and [Go SDK](/docs/jp/go-sdk/daytona#type-processservice) references:

> [**sendInput (TypeScript SDK)**](/docs/en/typescript-sdk/pty-handle#sendinput)
>
> [**SendInput (Go SDK)**](/docs/jp/go-sdk/daytona#PtyHandle.SendInput)
...
>
> [**Wait (Go SDK)**](/docs/jp/go-sdk/daytona#PtyHandle.Wait)
...
>
> [**WaitForConnection (Go SDK)**](/docs/jp/go-sdk/daytona#PtyHandle.WaitForConnection)
...
>
> [**Kill (Go SDK)**](/docs/jp/go-sdk/daytona#PtyHandle.Kill)
...
>
> [**Resize (Go SDK)**](/docs/jp/go-sdk/daytona#PtyHandle.Resize)
...
>
> [**Disconnect (Go SDK)**](/docs/jp/go-sdk/daytona#PtyHandle.Disconnect)
...
>
> [**IsConnected (Go SDK)**](/docs/jp/go-sdk/daytona#PtyHandle.IsConnected)
...
>
> [**ExitCode (Go SDK)**](/docs/jp/go-sdk/daytona#PtyHandle.ExitCode)
>
> [**Error (Go SDK)**](/docs/jp/go-sdk/daytona#PtyHandle.Error)
