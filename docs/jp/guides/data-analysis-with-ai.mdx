...
Now create a [Daytona sandbox](/docs/jp/sandboxes#basic-sandbox-creation) and upload your dataset:
...
<Frame>
<img src={'/assets/docs/images/chart-0.png'} alt="Vehicle valuation by manufacturing year chart" width={600} style="max-width: 100%; height: auto; margin: 1rem 0;" />
</Frame>
