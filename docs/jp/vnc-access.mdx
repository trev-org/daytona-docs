...
Daytona provides methods to [start](#start-vnc), [stop](#stop-vnc), and [monitor](#get-vnc-status) VNC sessions and processes programmatically using the [Computer Use](/docs/jp/computer-use) references as part of automated workflows.
...
For more information, see the [Computer Use](/docs/jp/computer-use#start-computer-use) reference.
...
>
> [**Start (Go SDK)**](/docs/jp/go-sdk/daytona#ComputerUseService.Start)
>
...
For more information, see the [Computer Use](/docs/jp/computer-use#stop-computer-use) reference.
...
>
> [**Stop (Go SDK)**](/docs/jp/go-sdk/daytona#ComputerUseService.Stop)
>
...
For more information, see the [Computer Use](/docs/jp/computer-use#get-status) reference.
...
>
> [**GetStatus (Go SDK)**](/docs/jp/go-sdk/daytona#ComputerUseService.GetStatus)
>
> [**Get Computer Use Status (API)**](/docs/jp/tools/api#daytona-toolbox/tag/computer-use/GET/computeruse/status)

For additional process management operations including restarting individual processes and viewing logs, see the [Computer Use](/docs/jp/computer-use) reference.
...
For complete documentation on automating desktop interactions, see [Computer Use](/docs/jp/computer-use).
