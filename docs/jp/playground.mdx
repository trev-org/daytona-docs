...
- [Web terminal](/docs/jp/web-terminal): run commands directly in your sandbox through a built-in web terminal
- [VNC access](/docs/jp/vnc-access): interact with GUI applications using [Computer Use](/docs/jp/computer-use) features
...
- [sandbox language](/docs/jp/sandboxes#multiple-runtime-support): select a programming language runtime for the sandbox
- [sandbox resources](/docs/jp/sandboxes#resources): configure resources allocated to the sandbox
- [sandbox lifecycle](/docs/jp/sandboxes#sandbox-lifecycle): set the sandbox lifecycle policies
...
For more information, see [file system operations](/docs/jp/file-system-operations).
...
For more information, see [Git operations](/docs/jp/git-operations).

### Process and code execution

The process and code execution section provides operations to run code snippets and shell commands directly in the sandbox. Shell commands are fixed, while code snippets change automatically based on the selected [sandbox language](/docs/jp/sandboxes#multiple-runtime-support) parameter.

For more information, see [process and code execution](/docs/jp/process-code-execution).
...
<Note>
Terminal access is restricted to authenticated members of your [organization](/docs/jp/organizations).
</Note>

For more information, see [web terminal](/docs/jp/web-terminal).

## VNC

The VNC tab provides graphical desktop access to the sandbox, enabling you to interact with GUI applications and test [Computer Use](/docs/jp/computer-use) features. The left panel contains interaction controls organized into sections. The right panel displays the desktop view.

For more information, see [VNC access](/docs/jp/vnc-access).
...
For more information, see [display operations](/docs/jp/computer-use#display-operations).
...
For more information, see [keyboard operations](/docs/jp/computer-use#keyboard-operations).
...
For more information, see [mouse operations](/docs/jp/computer-use#mouse-operations).
...
For more information, see [screenshot operations](/docs/jp/computer-use#screenshot-operations).

## Related

- [Web Terminal](/docs/jp/web-terminal): browser-based terminal access for sandboxes
- [VNC Access](/docs/jp/vnc-access): graphical desktop access for sandboxes
- [Computer Use](/docs/jp/computer-use): programmatic desktop automation
- [File System Operations](/docs/jp/file-system-operations): manage files and directories in sandboxes
- [Git Operations](/docs/jp/git-operations): manage Git repositories in sandboxes
- [Process & Code Execution](/docs/jp/process-code-execution): execute commands and run code in sandboxes
