...
> [**CreateSandboxFromSnapshotParams (Python SDK)**](/docs/en/python-sdk/sync/daytona#createSandboxBaseParams)
>
> [**CreateSandboxFromSnapshotParams (TypeScript SDK)**](/docs/en/typescript-sdk/daytona#createSandboxBaseParams)
>
> [**CreateSandboxFromSnapshotParams (Ruby SDK)**](/docs/en/ruby-sdk/daytona#createsandboxfromsnapshotparams)
...
> [**volume.delete (Python SDK)**](/docs/en/python-sdk/sync/volume#volumeservicedelete)
>
> [**volume.delete (TypeScript SDK)**](/docs/en/typescript-sdk/volume#delete)
>
> [**volume.delete (Ruby SDK)**](/docs/en/ruby-sdk/volume#delete)
