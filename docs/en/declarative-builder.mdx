...
2. [**Pre-built Snapshots**](#creating-pre-built-snapshots): create and register _ready-to-use_ [Snapshots](/docs/en/snapshots) that can be shared across multiple sandboxes
...
> [**CreateSandboxFromImageParams (Python SDK)**](/docs/en/python-sdk/sync/daytona#createsandboxfromimageparams)
>
> [**CreateSandboxFromImageParams (TypeScript SDK)**](/docs/en/typescript-sdk/daytona#createsandboxfromimageparams)
>
> [**CreateSandboxFromImageParams (Ruby SDK)**](/docs/en/ruby-sdk/daytona#createsandboxfromimageparams)
...
Daytona provides an option to [create pre-built snapshots](/docs/en/snapshots#create-snapshots) that can be reused across multiple sandboxes.
...
>
> [**CreateSnapshotParams (Ruby SDK)**](/docs/en/ruby-sdk/snapshot#createsnapshotparams)
...
For a complete API reference and method signatures, see the [Python](/docs/en/python-sdk/common/image) and [TypeScript](/docs/en/typescript-sdk/image) SDK references.
...
> [**base (Python SDK)**](/docs/en/python-sdk/common/image#imagebase)
>
> [**base (TypeScript SDK)**](/docs/en/typescript-sdk/image#base)
>
> [**debian_slim (Python SDK)**](/docs/en/python-sdk/common/image#imagedebian_slim)
>
> [**debianSlim (TypeScript SDK)**](/docs/en/typescript-sdk/image#debianslim)
...
> [**pip_install (Python SDK)**](/docs/en/python-sdk/common/image#imagepip_install)
>
> [**pipInstall (TypeScript SDK)**](/docs/en/typescript-sdk/image#pipinstall)
>
> [**pip_install_from_requirements (Python SDK)**](/docs/en/python-sdk/common/image#imagepip_install_from_requirements)
>
> [**pipInstallFromRequirements (TypeScript SDK)**](/docs/en/typescript-sdk/image#pipinstallfromrequirements)
>
> [**pip_install_from_pyproject (Python SDK)**](/docs/en/python-sdk/common/image#imagepip_install_from_pyproject)
>
> [**pipInstallFromPyproject (TypeScript SDK)**](/docs/en/typescript-sdk/image#pipinstallfrompyproject)
...
> [**add_local_file (Python SDK)**](/docs/en/python-sdk/common/image#imageadd_local_file)
>
> [**add_local_dir (Python SDK)**](/docs/en/python-sdk/common/image#imageadd_local_dir)
>
> [**addLocalFile (TypeScript SDK)**](/docs/en/typescript-sdk/image#addlocalfile)
>
> [**addLocalDir (TypeScript SDK)**](/docs/en/typescript-sdk/image#addlocaldir)
...
> [**env (Python SDK)**](/docs/en/python-sdk/common/image#imageenv)
>
> [**workdir (Python SDK)**](/docs/en/python-sdk/common/image#imageworkdir)
>
> [**env (TypeScript SDK)**](/docs/en/typescript-sdk/image#env)
>
> [**workdir (TypeScript SDK)**](/docs/en/typescript-sdk/image#workdir)
...
> [**run_commands (Python SDK)**](/docs/en/python-sdk/common/image#imagerun_commands)
>
> [**entrypoint (Python SDK)**](/docs/en/python-sdk/common/image#imageentrypoint)
>
> [**cmd (Python SDK)**](/docs/en/python-sdk/common/image#imagecmd)
>
> [**runCommands (TypeScript SDK)**](/docs/en/typescript-sdk/image#runcommands)
>
> [**entrypoint (TypeScript SDK)**](/docs/en/typescript-sdk/image#entrypoint)
>
> [**cmd (TypeScript SDK)**](/docs/en/typescript-sdk/image#cmd)
...
> [**dockerfile_commands (Python SDK)**](/docs/en/python-sdk/common/image#imagedockerfile_commands)
>
> [**from_dockerfile (Python SDK)**](/docs/en/python-sdk/common/image#imagefrom_dockerfile)
>
> [**dockerfileCommands (TypeScript SDK)**](/docs/en/typescript-sdk/image#dockerfilecommands)
>
> [**fromDockerfile (TypeScript SDK)**](/docs/en/typescript-sdk/image#fromdockerfile)
