...
This will stop Daytona from keeping sandboxes, that have [auto-stop enabled](/docs/en/sandboxes#auto-stop-interval), started:
...
The `sandboxToken` can be fetched through the [Daytona SDK or API](/docs/en/preview).
