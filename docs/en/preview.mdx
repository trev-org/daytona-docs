...
See: [get_preview_link (Python SDK)](/docs/en/python-sdk/sync/sandbox#sandboxget_preview_link), [getPreviewLink (TypeScript SDK)](/docs/en/typescript-sdk/sandbox#getpreviewlink), [preview_url (Ruby SDK)](/docs/en/ruby-sdk/sandbox#preview_url)
...
See: [create_signed_preview_url (Python SDK)](/docs/en/python-sdk/sync/sandbox#sandboxcreate_signed_preview_url), [getSignedPreviewUrl (TypeScript SDK)](/docs/en/typescript-sdk/sandbox#getsignedpreviewurl), [preview_url (Ruby SDK)](/docs/en/ruby-sdk/sandbox#preview_url)
