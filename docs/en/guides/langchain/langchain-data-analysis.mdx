...
<Frame>
<img src={'/assets/docs/images/langchain-data-analysis-chart.png'} alt="Vehicle valuation by manufacturing year chart" width={600} style="max-width: 100%; height: auto; margin: 1rem 0;" />
</Frame>
